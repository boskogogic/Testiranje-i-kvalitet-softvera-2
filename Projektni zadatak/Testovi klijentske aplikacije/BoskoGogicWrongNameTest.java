...
public class Test {
  ...
  public void () {
    ...
    driver.findElement(By.cssSelector(".ng-dirty:nth-child(2)")).sendKeys("B");
    ...
    driver.findElement(By.linkText("Add Student")).click();
    driver.findElement(By.cssSelector(".form-group:nth-child(1) > .form-control")).click();
    driver.findElement(By.cssSelector(".ng-dirty:nth-child(2)")).sendKeys("Aco");
    driver.findElement(By.cssSelector(".form-group:nth-child(2) > .form-control")).sendKeys("aleksandar@gmail.com");
    driver.findElement(By.cssSelector(".ng-untouched")).click();
    {
      WebElement dropdown = driver.findElement(By.cssSelector(".ng-untouched"));
      dropdown.findElement(By.xpath("//option[. = 'B-Tech']")).click();
